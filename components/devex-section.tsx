...
const STEPS = [
  {
    num: "01",
    title: "Get Started",
    desc: "Clone a live project of mine",
    file: "terminal",
    lang: "bash",
    code: [
      { type: "comment", text: "# Clone one of my live projects" },
      { type: "command", text: "git clone github.com/Rintu-chowdory/leadflowai" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@/lib/agents'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@/lib/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "output", text: "  Deploying to the edge..." },
      { type: "gap" },
      { type: "success", text: "✓ agent deployed" },
      { type: "url", text: "  → https://leadflowai-sepia.vercel.app" },
    ],
  },
]
